...
exports.errMassage = exports.catchingError = exports.errorTemp = void 0;
exports.errorTemp = (errCode) => {
    return {
        message: exports.errMassage[errCode] || "เกิดข้อผิดพลาดบางอย่าง",
        code: errCode,
    };
};
exports.catchingError = (res, err, errCode) => {
    if (err instanceof Error) {
        return res.status(400).json(exports.errorTemp(err.message));
    }
    else {
        return res.status(400).json(exports.errorTemp(errCode));
    }
};
exports.errMassage = {
    ...
    "report/invalid-date": "ไม่พบวันที่เริ่มต้นหรือวันที่สิ้นสุด กรุณาลองใหม่อีกครั้ง",
    "report/date-incorrect": "วันที่เริ่มต้นจะต้องน้อยกว่าวันที่สิ้นสุด กรุณาลองใหม่อีกครั้ง",
    "holiday/bad-request": "การดำเนินการขัดข้อง กรุณาดำเนินการใหม่อีกครั้ง",
    "holiday/financial-API-falied": "API ธนาคารกลางขัดข้อง กรุณาดำเนินการใหม่อีกครั้ง",
    ...
    "overtime/error-normal-day": "ไม่สามารถเพิ่มชั่วโมงการทำงานล่วงเวลาในเวลาทำงานปกติได้",
    "overtime/error-holiday": "ไม่สามารถเพิ่มชั่วโมงการทำงานที่ช่วงเวลา 00.00 น - 06.00 น. ในวันหยุดได้",
    "project/projectId-already-exist": "มีโครงการนี้ในระบบแล้ว ไม่สามารถดำเนินการซํ้าได้",
    "project/bad-request": "การดำเนินการขัดข้อง กรุณาดำเนินการใหม่อีกครั้ง",
    "register/email-already-exist": "มีอีเมลนี้ในระบบแล้ว ไม่สามารถดำเนินการซํ้าได้",
...
//# sourceMappingURL=errorsTemplate.js.map